...
export function AnalysisResults({ analysis }: AnalysisResultsProps) {
  ...
  const hasManyColumns = allColumns.length > 8;
    ...
    <div className="space-y-4">
        ...
        <CardContent className="pt-0">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              ...
              <div className="text-xs text-blue-600 dark:text-blue-400">Total Columns</div>
            </div>
      ...
      {numericColumns.length > 0 && (
        <Card>
          ...
          <CardContent className="pt-0">
            <div className={`grid gap-3 ${numericColumns.length > 3 ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`}>
